...
const servicesSchema = {
  ...
  description:
    "Professional junk removal, demolition & dumpster rental services in Monroe, West Monroe, Ruston & Northeast Louisiana. Same-day service available.",
    ...
    itemListElement: [
      {
        ...
        itemOffered: {
          ...
          description:
            "Home cleanouts, furniture removal, appliances removal in Monroe Louisiana",
        },
      },
      {
        "@type": "Offer",
        itemOffered: {
          ...
          description:
            "Office cleanouts, retail demolition, commercial junk removal in Monroe Louisiana",
        },
      },
      {
        "@type": "Offer",
        itemOffered: {
          ...
          description:
            "Construction cleanup, demolition debris removal in Monroe Louisiana",
        },
      },
    ],
  },
  ...
  review: [
    {
      ...
      reviewBody:
        "I had Kaleb and his crew move my household belongings from Farmerville to West Monroe. They have to be the best movers that I have ever used. So respectful, and careful with my stuff.",
    },
    {
      "@type": "Review",
      reviewRating: {
      ...
      reviewBody:
        "This young man did an awesome job. If you need anything hauled away this is the man. His prices are well below what it would cost you in time and gas to do it yourself.",
    },
  ],
  priceRange: "$$",
  openingHours: "Mo-Sa 07:00-20:00",
  sameAs: ["https://www.google.com/search?q=Kane+Pro+Junk+Removal+Monroe+LA"],
};
      ...
      <div className="max-w-6xl mx-auto px-3 sm:px-6 lg:px-8">
        <div className="text-center mb-8 sm:mb-10">
          ...
          <p className="text-sm sm:text-base text-gray-600 max-w-2xl mx-auto mb-4">
            See what Monroe, West Monroe, and Ruston customers say about our
      ...
      <section className="pt-4 sm:pt-8 pb-4 sm:pb-6 bg-white">
        <div className="max-w-6xl mx-auto px-3 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-sm sm:text-base lg:text-lg text-gray-600 max-w-2xl mx-auto leading-relaxed">
            Professional junk hauling, demolition & dumpster rental for homes
            and businesses across Monroe, West Monroe, Ruston & Northeast
            Louisiana
          </p>
          <div className="flex items-center justify-center gap-2 mt-3">
            ...
            <span className="text-sm text-gray-600">
              5.0 Stars • Same-Day Service Available
            </span>
          </div>
        </div>
      </section>
          ...
          <div className="space-y-8 sm:space-y-12">
            ...
            <div className="grid lg:grid-cols-2 gap-4 sm:gap-8 items-center">
              <div className="order-2 lg:order-1">
                ...
                <p className="text-sm sm:text-base text-gray-600 mb-3 sm:mb-4 leading-relaxed">
                  ...
                  Northeast Louisiana. We handle everything from single item
                  pickup to full estate cleanouts and small structure
                  demolition.
                </p>
            ...
            <div className="grid lg:grid-cols-2 gap-4 sm:gap-8 items-center">
              ...
              <div className="order-1 lg:order-2">
                ...
                <p className="text-sm sm:text-base text-gray-600 mb-3 sm:mb-4 leading-relaxed">
                  Professional commercial cleanouts and demolition for Monroe
                  Louisiana businesses. We work around your schedule to minimize
                  disruption to your operations while providing efficient junk
            ...
            <div className="grid lg:grid-cols-2 gap-4 sm:gap-8 items-center">
              <div className="order-2 lg:order-1">
                ...
                <p className="text-sm sm:text-base text-gray-600 mb-3 sm:mb-4 leading-relaxed">
                  ...
                  site requirements and help keep your projects on schedule
      ...
      <section className="py-8 sm:py-12 lg:py-16 bg-deep-green text-white">
        <div className="max-w-4xl mx-auto px-3 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-sm sm:text-base text-gray-300 mb-4 sm:mb-6 max-w-2xl mx-auto leading-relaxed">
            ...
            same-day junk removal and demolition service. Licensed, insured, and
            5-star rated!
          </p>
